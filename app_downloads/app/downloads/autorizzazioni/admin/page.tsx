...
export default function AutorizzazioniAdminPage() {
  ...
  if (!isAuthenticated) {
    return <AdminLogin returnUrl="/downloads/autorizzazioni/admin" />
  }
    ...
    <div className="min-h-screen bg-gray-900 p-4">
      ...
      <div className="flex justify-end items-center mb-8 pt-16">
        ...
        <div className="space-x-4">
          <Button onClick={() => router.push('/downloads/autorizzazioni')} className="bg-[#20a136] text-white hover:bg-[#2dc14a]">
